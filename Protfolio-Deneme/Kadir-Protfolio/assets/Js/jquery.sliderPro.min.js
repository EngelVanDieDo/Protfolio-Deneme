...
!(function (c, p) {
    ...
    n.prototype = {
      _init: function () {
        ...
        p(c).on("resize." + this.uniqueId + "." + m, function () {
          ...
          !1 === e.allowResize ||
            ...
            (e.allowResize = !1),
            (e.timers.allowResize = setTimeout(function () {
              delete e.timers.allowResize, e.resize(), (e.allowResize = !0);
            }, 200)));
        }),
      ...
      destroy: function () {
        ...
        var t,
          i = p.SliderPro.modules;
        if (void 0 !== i)
          for (var e = 0; e < i.length; e++)
            void 0 !== this["destroy" + i[e]] && this["destroy" + i[e]]();
        for (t in (p.each(this.slides, function (t, i) {
          i.destroy();
        }),
        (this.slides.length = 0),
        this.timers))
          clearTimeout(this.timers[t]), delete this.timers[t];
        this.$slides.prependTo(this.$slider), this.$slidesContainer.remove();
      },
            ...
            if (
              ...
              this.$thumbnails.find(".sp-thumbnail").each(function (t) {
                ...
                "horizontal" === this.thumbnailsOrientation
                  ...
                  : (this.$thumbnails.css({
                      width: this.settings.thumbnailWidths,
    ...
    (function (t) {
      "use strict";
      var i = "MouseWheel." + t.SliderPro.namespace;
      t.SliderPro.addModule("MouseWheel", {
        mouseWheelEventType: "",
        initMouseWheel: function () {
          ...
          !1 !== this.settings.mouseWheel &&
            ("onwheel" in document
              ...
              : "onMozMousePixelScroll" in document &&
            ...
            this.on(this.mouseWheelEventType + "." + i, function (t) {
              ...
              void 0 !== t.detail && (i = t.detail),
                void 0 !== t.wheelDelta && (i = t.wheelDelta),
                void 0 !== t.deltaY && (i = -1 * t.deltaY),
                e.thumbnailsPosition + i < 0 &&
                e.thumbnailsPosition + i >
                  e.thumbnailsContainerSize - e.thumbnailsSize
                  ? e._moveThumbnailsTo(e.thumbnailsPosition + i, !0)
                  : 0 <= e.thumbnailsPosition + i
                  ? e._moveThumbnailsTo(0, !0)
                  : e.thumbnailsPosition + i <
                      e.thumbnailsContainerSize - e.thumbnailsSize &&
                    e._moveThumbnailsTo(
                      e.thumbnailsContainerSize - e.thumbnailsSize,
        ...
        mouseWheelDefaults: { mouseWheel: !1 },
      });
    })((window, jQuery)),
    (function (t) {
      "use strict";
